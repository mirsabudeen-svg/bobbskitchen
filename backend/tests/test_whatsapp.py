...
class TestReadyTransitionTrigger:
    ...
    @pytest.mark.asyncio
    async def test_marking_ready_fires_whatsapp(self, async_client, db):
        client = async_client
        """
    ...
    @pytest.mark.asyncio
    async def test_whatsapp_failure_does_not_block_status_transition(self, async_client, db):
        client = async_client
        """
    ...
    @pytest.mark.asyncio
    async def test_non_ready_transitions_do_not_trigger_whatsapp(self, async_client, db):
        client = async_client
...
class TestWhatsAppRetry:
    ...
    @pytest.mark.asyncio
    async def test_retry_succeeds_on_ready_order(self, async_client, db):
        client = async_client
        from tests.conftest import seed_kiosk_session, seed_variant, make_order_payload
    ...
    @pytest.mark.asyncio
    async def test_retry_blocked_on_pending_order(self, async_client, db):
        client = async_client
        from tests.conftest import seed_kiosk_session, seed_variant, make_order_payload
    ...
    @pytest.mark.asyncio
    async def test_retry_rate_limited_after_3_attempts(self, async_client, db):
        client = async_client
        from tests.conftest import seed_kiosk_session, seed_variant, make_order_payload
